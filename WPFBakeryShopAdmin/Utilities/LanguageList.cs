...
namespace WPFBakeryShopAdmin.Utilities
{
    public class LanguageList
    {
        ...
        static LanguageList()
        {
            ...
            _enlishDictionary.Source = new Uri("..\\Languages\\StringResources.en.xaml", UriKind.Relative);
            _vnDictionary.Source = new Uri("..\\Languages\\StringResources.vn.xaml", UriKind.Relative);
        }
